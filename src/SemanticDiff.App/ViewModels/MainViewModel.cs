...
public sealed partial class MainViewModel : ObservableObject, IAsyncDisposable
{
    ...
    public void OpenSymbolGraphFromCurrentFilters()
    {
        OpenSymbolGraphTab(
            ...
            $"filtered:{SymbolSearchText}|{selectedSymbolScopeFilter}|{selectedSymbolKindFilter}|{selectedSymbolDocumentFilter}",
            initialSearchText: SymbolSearchText,
            initialScopeKey: selectedSymbolScopeFilter,
            initialKindKey: selectedSymbolKindFilter,
            initialDocumentId: selectedSymbolDocumentFilter);
    }
    ...
    private void OpenSymbolGraphTab(
        ...
        string initialScopeKey = SymbolFilterAll,
        string initialKindKey = SymbolFilterAll,
        string initialDocumentId = SymbolFilterAll,
